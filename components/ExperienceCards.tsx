...
function ExperienceCards({}: Props) {
  return (
    <article className='flex flex-col rounded-lg items-center space-y-5 flex-shrink-0 w-full max-w-[500px] md:max-w-[600px] xl:max-w-[700px] snap-center 
    p-10 bg-[#292929] opacity-40 hover:opacity-100 cursor-pointer transition-opacity duration-200 overflow-hidden md:overflow-y-auto'>
      <motion.img
      ...
      <div className='px-0 md:px-10'>
        <h4 className='text-2xl md:text-4xl'>Software Engineer</h4>
        <p className='font-bold text-xl md:text-2xl mt-1'>Dell Technologies</p>
        <div className='flex space-x-2 my-2'>
          {/* Tech used */}
        </div>
        <p className='uppercase py-5 text-gray-300 text-sm md:text-base'>Started working ... - Ended working...</p>
