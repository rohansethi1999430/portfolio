    ...
    <motion.div 
      ...
      md:flex-row max-w-7xl px-4 md:px-10 justify-evenly mx-auto items-center'>
        ...
        <motion.img 
          ...
          viewport={{ once: true }}
          className='mt-20 md:mt-0 -mb-10 md:mb-0 flex-shrink-0 w-40 h-40 rounded-full object-cover md:rounded-lg md:w-64 
          md:h-96 xl:w-[400px] xl:h-[500px] xl:rounded-lg'
        />

        <div className='space-y-5 md:space-y-10 px-4 md:px-10 mt-20 md:mt-0'>
